...
import static io.caligoals.caligoals.config.SecurityConstants.*;
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            if (user != null) {
                ...
                User u = ((AppUserDetails) userDetailsService.loadUserByUsername(user)).getUser();
                return new UsernamePasswordAuthenticationToken(u, token, new ArrayList<>());
            }
            return null;
        }
